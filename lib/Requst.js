...
class Requst extends EventEmitter {
    ...
    constructor (client, url, options = {}, fileDownloadOptions) {
    ...
    get fileName () {
        ...
        if (this.fileDownloadOptions.useRemoteFileName) s = this.remoteFileName
    ...
    get filePath () {
        ...
        return Path.join (this.fileDownloadOptions.dir, this.fileName)
